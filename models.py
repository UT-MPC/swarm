...
def get_hetero_cnn_cifar_model(size = 3):
    ...
    if size == 3:
        ...
        model.add(Activation('relu'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(MaxPooling2D(pool_size=(2, 2), name='layer_{}'.format(0, random.randint(RAND_MAX))))

        model.add(Conv2D(64, (3, 3), padding='same', name='layer_{}'.format(0, random.randint(RAND_MAX))))
        model.add(Activation('relu'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(Conv2D(64, (3, 3), name='layer_{}'.format(0, random.randint(RAND_MAX))))
        model.add(Activation('relu'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(MaxPooling2D(pool_size=(2, 2), name='layer_{}'.format(0, random.randint(RAND_MAX))))

        model.add(Flatten(), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(Dense(512), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(Activation('relu'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(Dense(10), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(Activation('softmax'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        ...
        model.add(Conv2D(48, (3, 3), padding='same', name='layer_{}'.format(0, random.randint(RAND_MAX))))
        model.add(Activation('relu'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(Conv2D(48, (3, 3), name='layer_{}'.format(0, random.randint(RAND_MAX))))
        model.add(Activation('relu'), name='layer_{}'.format(0, random.randint(RAND_MAX)))
        model.add(MaxPooling2D(pool_size=(2, 2), name='layer_{}'.format(0, random.randint(RAND_MAX))))
        ...
        model.add(Conv2D(32, (3, 3), padding='same', name='layer_{}'.format(random.randint(RAND_MAX))))
        model.add(Activation('relu'), name='layer_{}'.format(random.randint(RAND_MAX)))
        model.add(Conv2D(32, (3, 3), name='layer_{}'.format(random.randint(RAND_MAX))))
        model.add(Activation('relu'), name='layer_{}'.format(random.randint(RAND_MAX)))
        model.add(MaxPooling2D(pool_size=(2, 2), name='layer_{}'.format(random.randint(RAND_MAX))))
        ...
        model.add(Flatten(), name='layer_{}'.format(random.randint(RAND_MAX)))
        model.add(Dense(256), name='layer_{}'.format(random.randint(RAND_MAX)))
        model.add(Activation('relu'), name='layer_{}'.format(random.randint(RAND_MAX)))
        model.add(Dense(10), name='layer_{}'.format(random.randint(RAND_MAX)))
        model.add(Activation('softmax'), name='layer_{}'.format(random.randint(RAND_MAX)))
    else:
